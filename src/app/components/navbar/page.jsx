      ...
      <section id="datas1" className="max-h-[100vh] animate-slideIn div-2 my-auto">
        ...
        <div className="text-[#fff] mt-[100px] flex px-5 max-w-[1760px] mx-auto justify-between items-center">
          <div>
            ...
            {/* Ijtimoiy tarmoq belgilarini qo'shishingiz mumkin */}
            <p>
              <svg
                width="24"
                height="24"
      ...
      <section id="datas5" className="animate-slideIn h-[20vh] div-2 mt-[50px] ">
        <div className="flex justify-between max-w-[1760px] mx-auto pb-[50px]">
          <div className="flex flex-col max-w-[370px]">
            ...
            <a
              className="font-[500] mt-[120px] text-[18px] text-[#ffffff6f]"
              href=""
            >
          ...
          <div className="flex w-[700px] justify-between">
            <div className="flex flex-col gap-[16px]">
              <a className="text-[#fbd784] font-[700] text-[24px]" href="">
                More on The Blog
              </a>
              <a className="font-[500] text-[18px]" href="">
                About MNTN
              </a>
              <a className="font-[500] text-[18px]" href="">
